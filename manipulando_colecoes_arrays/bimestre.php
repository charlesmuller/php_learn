...
//
//var_dump(array_diff_assoc($notasBimestre1, $notasBimestre2)); //compara os dois arrays e retorna os elementos (tanto chave quanto valor) e retorna quem não está no primeiro array
//
